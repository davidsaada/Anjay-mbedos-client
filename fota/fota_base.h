...
#define FOTA_UINT16_LE  __builtin_bswap16
#define FOTA_UINT32_LE  __builtin_bswap32
#define FOTA_UINT64_LE  __builtin_bswap64
#define FOTA_UINT16_BE
#define FOTA_UINT32_BE
#define FOTA_UINT64_BE
#else
#define FOTA_UINT16_LE
#define FOTA_UINT32_LE
#define FOTA_UINT64_LE
#define FOTA_UINT16_BE  __builtin_bswap16
#define FOTA_UINT32_BE  __builtin_bswap32
#define FOTA_UINT64_BE  __builtin_bswap64
#endif

#elif defined __CC_ARM
#ifdef __BIG_ENDIAN
#define FOTA_UINT16_LE(x)  ((x >> 8) | ((x & 0xFF) << 8))
#define FOTA_UINT32_LE(x)  __rev(x)
#define FOTA_UINT64_LE(x)  (((uint64_t)__rev((uint32_t)x) << 32) | (uint64_t)__rev((uint32_t)(x >> 32)))
#define FOTA_UINT16_BE(x)  (x)
#define FOTA_UINT32_BE(x)  (x)
#define FOTA_UINT64_BE(x)  (x)
#else
#define FOTA_UINT16_LE(x)  (x)
#define FOTA_UINT32_LE(x)  (x)
#define FOTA_UINT64_LE(x)  (x)
#define FOTA_UINT16_BE(x)  ((x >> 8) | ((x & 0xFF) << 8))
#define FOTA_UINT32_BE(x)  __rev(x)
#define FOTA_UINT64_BE(x)  (((uint64_t)__rev((uint32_t)x) << 32) | (uint64_t)__rev((uint32_t)(x >> 32)))
#endif
#endif
